...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c5 = function(id, source, target) {
        ...
        peg$c8 = "",
        peg$c9 = function(idParts) { if(idParts.length > 1) { return idParts[1]; } else { return null; } },
        peg$c10 = peg$otherExpectation("identity"),
        peg$c11 = /^[0-9a-zA-Z\u0430-\u044F\u0451\u0410-\u042F\u0401]/,
        peg$c12 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"], ["\u0430", "\u044F"], "\u0451", ["\u0410", "\u042F"], "\u0401"], false, false),
    ...
    function peg$parseLink() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parseIdOrNull();
        if (s2 !== peg$FAILED) {
          s3 = peg$parse_();
          if (s3 !== peg$FAILED) {
            s4 = peg$parseIdentityOrLink();
            if (s4 !== peg$FAILED) {
              s5 = peg$parse_();
              if (s5 !== peg$FAILED) {
                s6 = peg$parseIdentityOrLink();
                if (s6 !== peg$FAILED) {
                  s7 = peg$parse_();
                  if (s7 !== peg$FAILED) {
